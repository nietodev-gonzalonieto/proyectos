...
<body>
	...
	<a name="editar"></a>
	<h1>Añadir Pruebas</h1>
	<form method="post" enctype="multipart/form-data" action="">
		<div class="form-group">
			<label for="pista1">Pista1</label>
			<input type="text" name="pista1" id="pista1" required><br><br>
		</div>
		<div class="form-group">
			<label for="pista2">Pista2</label>
			<input type="text" name="pista2" id="pista2" required><br><br>
		</div>
		<div class="form-group">
		    <label for="pista3">pista3</label>
		    <input type="text" name="pista3" id="pista3" required><br><br>
		</div>
		<div class="form-group">
		    <label for="resultado">Resultado</label>
		    <input type="text" name="resultado" id="resultado" required><br><br>
		</div>
		<div class="form-group">
...
<?php
		echo "<table id='tabla'class='cell-border'>
			<thead>
                <tr>
					<th>Id</th>
                    <th>Pista1</th>
        ...
        $resultat = mysqli_query($enlace,$query);
		echo "<br><br><br><br><br>";
        echo "<table id='tabla2' class='cell-border'>
			<thead>
                <tr>
					<th>Id</th>
                    <th>Pista1</th>
