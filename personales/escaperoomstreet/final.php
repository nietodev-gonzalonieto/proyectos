...
<html lang="es">
  ...
  <div id="pub" style="height:100%;position:fixed;background-color:black;top:0px;z-index:99;display:none;"><img id="imagenPub" style="max-width:100%;"src=""></div>
	<div class="header">
	...
	<center>
		...
		<div class="row">
		  ...
		  <!--fila tres-->
			<div class="col-4">
			  ...
			  <p style="font-size:0.8em;">Paca Garte</p>
			</div>
			<div class="col-4">
	  ...
	  <center>
			...
			<div class="row">
				<div class="col-12">
					<div id="prueba1Estado0">
						...
						<p style="color:red;" id="textoErrorPrueba1"></p>
					...
					<div id="prueba1Estado1" style="display:none;">
						...
						<p style="color:black;font-weight:bold;">FES CLIC A LA INFORMACIÒ RELLEVANT, PER ENMAGATZEMAR-LA AL HISTORIAL</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="prueba2" class="espaciadoAbajoSolo textoBlanco" style="display:none;">
			<div class="row">
				<div class="col-12">
					<img src="images/pruebas/prueba2/azul2.jpg" style="max-width:100%;"><br><br>
				</div>
			</div><br><br>
			<div class="row">
				<div class="col-12">
					<div style="background-color:#075e54">
						<div class="row">
							...
							<div class="col-4">
								<div style="text-align:left;font-weight:bold;">Perruqueria<br><span id="escrbiendo" style="font-size:0.7em;">En linea</span></div>
							</div>
							<div class="col-6">
			...
			<div class="row">
				<div class="col-12">
					...
					<div id="prueba3Estado1" style="display:none;">
						<img src="images/pruebas/prueba3/prueba3Senales.jpg" style="max-width:100%;">
						<br><br><br>
						<div class="form-group">
					...
					<div id="prueba3Estado2" style="display:none;">
						<p>Benvingut/da als nostres arxius de trànsit secrets. Segons hem pogut comprovar per les pistes i anotacions que hem trobat de la policia, la informaciò que tenim és: <br><span onclick="guardarPruebaDiario();" class="respuestaEstablecimiento"  id="resultadoPrueba3"></span></p>
		...
		<div id="prueba5" class="espaciadoAbajoSolo textoBlanco" style="display:none;">
			<div class="row" id="prueba5Parte1">
				<div class="col-12">
				<p>En aquest establiment creiem que han sigut testimonis del robatori o del culpable. Però no serà tan fàcil que ens proporcionin informació. Haurem d’ajudar-los.</p>
				<p>En Dani no pot accedir al seu magatzem perquè ha perdut les claus. Les tenia a dins el bar, però l’ha estat buscant i no les troba enlloc. Connecta't a les càmeres de seguretat i ajuda'l.</p>
			...
			<div class="row" id="prueba5Parte2" style="display:none;">
				...
				<div class="col-12" id="prueba5Parte3" style="display:none;">
					...
					<img id="imagen0Prueba5" src="images/pruebas/prueba5/camara0.jpg" style="max-width:100%;">
					<img id="imagen1Prueba5" src="images/pruebas/prueba5/camara1.jpg" style="display:none;max-width:100%;">
					<img id="imagen2Prueba5" onclick="prueba5ClicImagen(event);" src="images/pruebas/prueba5/camara2.jpg" style="display:none;max-width:100%;">
					<img id="imagen3Prueba5" src="images/pruebas/prueba5/camara3.jpg" style="display:none;max-width:100%;"><br><br>
				...
				<div id="errorHuellaDactilar" style="display:none;">
					...
					<div id="huellasDactilares">
						<div class="row">
							...
							<div class="col-4">
								<img src="images/pruebas/prueba6/3.png" onclick="huellaDactilarComprobar(true);" style="max-width:100%;">
							</div>
						</div><br>
						<div class="row">
							<div class="col-4">
								<img src="images/pruebas/prueba6/4.png" onclick="huellaDactilarComprobar();" style="max-width:100%;">
							</div>
							<div class="col-4">
		...
		<div id="prueba10" class="espaciadoAbajoSolo textoBlanco" style="display:none;">
			<div class="row" id="prueba10Parte1">
				<div class="col-12">
					...
					<p id="codigoIncorrectoPrueba10" style="display:none;color:red;">Aquesta imatge no representa la clínica que tens davant.</p>
				</div>
				<div class="col-4">
					<img src="images/pruebas/prueba10/1.jpg" onclick="comprobarPrueba10(false);" style="border-radius:3px;max-width:100%;"><br><br>
				</div>
				<div class="col-4">
					<img src="images/pruebas/prueba10/2.jpg" onclick="comprobarPrueba10(false);" style="border-radius:3px;max-width:100%;"><br><br>
				</div>
				<div class="col-4">
				...
				<div class="col-4">
					<img src="images/pruebas/prueba10/8.jpg" onclick="comprobarPrueba10(true);" style="border-radius:3px;max-width:100%;"><br><br>
				</div>
				<div class="col-4">
			...
			<div class="row" id="prueba10Parte2" style="display:none;">
				<div class="col-12" id="prueba10Parte2Barra">
					...
					<center><div>Hackejant cámeres de seguretat</div></center>
				</div>
				<div class="col-12" id="prueba10Parte2Codigo" style="display:none;">
					<img id="prueba10Imagen" src="images/pruebas/prueba10/1.jpeg" style="border-radius:10px;max-width:100%;"><br><br>
			...
			<div class="row" id="prueba10Parte3" style="display:none;">
				<div class="col-12">
					...
					<p>El botiguer, esta molt agraït i ens ha dit:</p>
		...
		<div id="prueba11" class="espaciadoAbajoSolo textoBlanco" style="display:none;">
			<div class="row" id="prueba11Parte1">
				<div class="col-12">
					<p>En aquest establiment tenen un menú especial. És conegut al poble pel seu plat estrella. La cuinera de l’establiment no ens donarà cap informació fins que no provem la seva sopa. Així que, endavant.</p>
					<p>Hi ha uns quants números que sobren</p>
				</div>
				<div class="col-12">
					<table style="border:1px solid;width:100%;">
						<tr>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">3</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">8</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">1</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">6</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">7</td>
						</tr>
						<tr>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">3</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">4</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">5</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">7</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">9</td>
						</tr>
						<tr>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">5</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">7</td>
						...
						<tr>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">4</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">1</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">2</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">5</td>
							<td style="border:1px solid orange;text-align:center;padding:10px;font-size:1.6em;color:#E1DEDE;font-weight:bold;" onclick="tachar(this);">3</td>
						</tr>
						<tr>
				...
				<div class="col-12">
					<div class="form-group">
						<p id="codigoIncorrectoPrueba11" style="display:none;color:red;">Error! Introdueix el prefixe correcte.</p>
	...
	<center>
		<div class="row">
			<div class="col-12">
				<h4 style="color:white;">Ha arribat l'hora d'escollir el sospitós, recorda que no pots fallar. Si fallas haurás de començar una partida nova.</h4>
	 ...
	 <script type="text/javascript">
	  ...
	  var totalDeTiendas = 6;
		...
		function obtenerPista(id_prueba,numero){					//Funcion que te da una pista en función de la prueba y la dificultad de la pista que le pidamos.
			...
			console.log(id_prueba+puntoActual+"pista"+numero);
			console.log("pista"+numero);
		...
		function leerArray(){         //Pintar Array
			...
			$("#destino0").append("<h4><i class='fas fa-map-marker-alt'></i> Partint de la Biblioteca</h4>");
			if(partida[0][0]["id_clave"]==1){			//En caso de que la tienda tenga como referencia el punto de partida
				...
				$("#destino0").append("<h4>Com arribar al primer destí:</h4> <p><i class='fas fa-map-marker-alt'></i> " + deClaveAClave(1,partida[0][0]["id_clave"]) + "</p>");
		...
		function prueba5ClicImagen(e){
			...
			widthImagenPrueba5max = widthImagenPrueba5 - (widthImagenPrueba5/4);
			heightImagenPrueba5 = document.getElementById("imagen2Prueba5").clientHeight;
			heightImagenPrueba5min = heightImagenPrueba5 - (heightImagenPrueba5/3);
		...
		function prueba10siguiente(){
			...
			$("#prueba10Imagen").attr("src","images/pruebas/prueba10/"+contadorPrueba10+".jpeg");
		}
		...
		function tachar(elemento){
			...
			if($(elemento).css("color") == "rgb(0, 0, 0)"){
		...
		function pintarHistorial(){
			...
			if(localStorage.getItem('historial')){
				...
				$("#historial").append('<center><div class="row"><div class="col-12"><h4 style="color:white;">No tienes información guardada, visita comercios y obten información sobre el ladrón</h4></div></div></center>');
			}
			mostrar("historial",1);
		}
		...
		function escribirPista(){
			if(control){
				...
				if (contadorPista <4) {
					...
					$('#todasLasPistas').prepend(obtenerPista(partida[0][puntoActual].id_prueba, contadorPista)+"<br>");
				} else {
					$('#noHayMasPistas').show();
					$('#botonPista').hide();
				}
