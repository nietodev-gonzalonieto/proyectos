	  ...
	  <center>
				...
				<div class="col-12">
					<div style="background-color:#075e54">
						<div class="row">
							...
							<div class="col-4">
								<div style="text-align:left;font-weight:bold;">Velis<br><span id="escrbiendo" style="font-size:0.7em;">En linea</span></div>
							</div>
							<div class="col-6">
					...
					<div style="background-color:#E8DCCF;"><br>
						...
						<div class="row">
							<div class="col-11" style="text-align: left;">
							<div style="border-radius:5px;color:black;display:inline-block;padding:5px;background-color:#dcf8c6; text-align:left;">No t'ho puc dir, guarda'm com Velis, no vull que ningú s'assabenti de qui sóc&nbsp;&nbsp;<div style="text-align:right;font-size:0.7em;">18:57</div></div>
							</div>
						</div><br>
						<div class="row">
							<div class="col-4">
			...
			<div class="row">
				<div class="col-12">
					...
					<div id="prueba3Estado1" style="display:none;">
						<p>Mapa de transcripcions:</p>
						<img src="images\pruebas\prueba3\prueba3Deportes.jpg" style="max-width:100%;"><br><br>
						<div class="form-group">
				...
				<div class="col-12">
					...
					<div id="prueba4Estado1" >
						...
						<div class="row">
							...
							<div class="col-4" style="background-color: #F400A1; height: 7em;" onclick="modalPrueba4();"></div>
						...
						<div class="row">
							...
							<div class="col-4" style="background-color: #FF1717; height: 7em;" onclick="modalPrueba4(true);"></div>
					...
					<div id="prueba4Estado2" style="display:none;">
						<img src="images/pruebas/prueba4/prueba4diariorojo.jpg" style="max-width:100%;">
		...
		<div id="prueba5" class="espaciadoAbajoSolo textoBlanco" style="display:none;">
			<div class="row" id="prueba5Parte1">
				<div class="col-12">
				<p>En aquest establiment segur que han vist alguna cosa. Han sigut testimonis del robatori o del culpable. Però no serà tan fàcil que ens proporcionin informació. Haurem d’ajudar-los a resoldre la seva missió. </p>
				<p>El propietari no pot accedir al seu magatzem perquè ha perdut les claus. Les tenia a dins el bar, però l’ha estat buscant i no les troba enlloc. Haurem d’ajudar-lo perquè ens doni la informació que necessitem i seguir amb la investigació.</p>
			...
			<div class="row" id="prueba5Parte2" style="display:none;">
				...
				<div class="col-12" id="prueba5Parte3" style="display:none;">
					...
					<img id="imagen0Prueba5" src="images/pruebas/prueba5/segur/camara0.jfif" style="max-width:100%;">
					<img id="imagen1Prueba5" src="images/pruebas/prueba5/segur/camara1.jfif" style="display:none;max-width:100%;">
					<img id="imagen2Prueba5" onclick="prueba5ClicImagen(event);" src="images/pruebas/prueba5/segur/camara2.jfif" style="display:none;max-width:100%;">
					<img id="imagen3Prueba5" src="images/pruebas/prueba5/segur/camara3.jfif" style="display:none;max-width:100%;"><br><br>
		...
		<div id="prueba10" class="espaciadoAbajoSolo textoBlanco" style="display:none;">
			<div class="row" id="prueba10Parte1">
				<div class="col-12">
					...
					<p id="codigoIncorrectoPrueba10" style="display:none;color:red;">Aquesta imatge no representa l'establiment que tens davant.</p>
				</div>
				<div class="col-4">
				...
				<div class="col-4">
					<img src="images/pruebas/prueba10/10.jpg" onclick="comprobarPrueba10(true);" style="border-radius:3px;max-width:100%;"><br><br>
				</div>
				<div class="col-4">
			...
			<div class="row" id="prueba10Parte2" style="display:none;">
				...
				<div class="col-12" id="prueba10Parte2Codigo" style="display:none;">
					<img id="prueba10Imagen" src="images/pruebas/prueba10/segur/0.jpg" style="border-radius:10px;max-width:100%;"><br><br>
	 ...
	 <script type="text/javascript">
	  ...
	  var totalDeTiendas = 6;
		...
		function leerArray(){         //Pintar Array
			...
			if(partida[0][0]["id_clave"]==15){			//En caso de que la tienda tenga como referencia el punto de partida
				...
				$("#destino0").append("<h4>Com arribar al primer destí:</h4> <p><i class='fas fa-map-marker-alt'></i> " + deClaveAClave(15,partida[0][0]["id_clave"]) + "</p>");
		...
		function comprobarPrueba3Estado1() {
			var resultado = $("#textoPrueba3Estado1").val();
			resultado = resultado.toUpperCase();
			resultado = resultado.trim();
			if (resultado == 'SANTMIQUEL' || resultado == 'SANT MIQUEL') {
				$("#prueba3Estado0").hide();
				$("#prueba3Estado1").hide();
				$("#prueba3Estado2").show();
		...
		function prueba10siguiente(){
			...
			$("#prueba10Imagen").attr("src","images/pruebas/prueba10/segur/"+contadorPrueba10+".jpg");
		}
