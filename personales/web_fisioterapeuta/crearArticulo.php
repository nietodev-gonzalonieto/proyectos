<?php
   ...
   if ($usuario != 'sandra') {
        if ($contrasena != 'Stl020217') {
            header('Location: https://www.fisioterapiavendrell.com');
        }
    }
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Contacto - Fisioterapia Online - Contactar - Fisioterapia Online Espalda</title>
    ...
    <main>
        ...
        <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Crea tu artículo</h2>
                    </div>
                    <div class="col-lg-12">
                        <span style="display: none;" id="cargando"><img src="assets/img/logo/ajax-loader.gif"></span>
                    </div>
                    <div class="col-lg-12">
                        <h3 style="display: none;" id="enviado">¡Enviado!</h3>
                    </div>
                    <script type="text/javascript">
                        var checkCorreo=false;
                        function queSeMuestre(id){
                            document.getElementById(id).style.display = "block";
                        }
                        function queNoSeMuestre(id){
                            document.getElementById(id).style.display = "none";
                        }
                        function tiempo() {
                            if (!checkCorreo) {
                                checkCorreo=true;
                                queNoSeMuestre('enviado');
                                queSeMuestre('cargando');
                                setTimeout(function(){
                                    checkCorreo=false
                                    queNoSeMuestre('cargando');
                                    queSeMuestre('enviado');
                                }, 5000);
                            }
                        }
                    </script>
                    <div class="col-lg-8">
                        <form action="recogida.php" enctype="multipart/form-data" method="post">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="tituloParrafo1" id="titulo1" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduce el titulo'" placeholder="Introduce el titulo">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="parrafo1" id="parrafo1" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Escribe el párrafo 1'" placeholder=" Escribe el párrafo 1"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="file" name="imagenPrincipal" id="imagen1">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="tituloParrafo2" id="titulo2" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduce el titulo2'" placeholder="Introduce el titulo2">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="parrafo2" id="parrafo2" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Escribe el párrafo 2'" placeholder=" Escribe el párrafo 2"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="tituloParrafo3" id="titulo3" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduce el titulo3'" placeholder="Introduce el titulo3">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="parrafo3" id="parrafo3" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Escribe el párrafo 3'" placeholder=" Escribe el párrafo 3"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="tituloParrafo4" id="titulo4" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduce el titulo4'" placeholder="Introduce el titulo4">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="parrafo4" id="parrafo4" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Escribe el párrafo 4'" placeholder=" Escribe el párrafo 4"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="tituloParrafo5" id="titulo5" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduce el titulo5'" placeholder="Introduce el titulo5">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="parrafo5" id="parrafo5" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Escribe el párrafo 5'" placeholder=" Escribe el párrafo 5"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="mensajeLargo" id="mensajeLargo" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Escribe la descripcion larga'" placeholder=" Escribe la descripcion larga"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="mensajeCorto" id="mensajeCorto" cols="15" rows="4" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Escribe la descripcion corta'" placeholder=" Escribe la descripcion corta"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3">
                                <button type="submit" class="button button-contactForm boxed-btn" id="enviar" name="enviar" onclick="tiempo()">Enviar</button>
                            </div>
                        </form>
                    </div>
                </div>
