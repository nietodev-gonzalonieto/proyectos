...
<head>
    ...
    <meta name="description" content="Encuentra un centro de fisioterapia cerca de El Vendrell , con parking y servicios cercanos">
    <link rel=“canonical” href=“https://www.fisioterapiavendrell.com/contacto” />
        ...
        <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="contactoprueba.php" method="post" id="contactForm" novalidate="novalidate">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Deja tu mensaje'" placeholder=" Deja tu mensaje"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduce tu nombre'" placeholder="Introduce tu nombre">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduce tu email'" placeholder="Email">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="telefono" id="telefono" type="tel" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduce tu teléfono'" placeholder="Telefono">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>El Vendrell, Tarragona.</h3>
                                <p>c/ Josep Irla Bosch, 22, 1-2,43700 </p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                            <div class="media-body">
                                <h3>+34 620 33 36 32</h3>
                                <p>Lunes a Viernes<br>  9:00-14:00 a 16:00-21:00</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>contacto@fisioterapiavendrell.com</h3>
         ...
         <div class="single-testimonial text-center" style="width: 99%;">
            <!-- Testimonial Content -->
            <div class="row justify-content-center">
                <div class="col-xl-12 col-md-12 col-sm-12 col-sm-12">
                    <div class="section-tittle text-center mb-100">
                        <span>Sandra Tablado <strong>Fisioterapeuta</strong></span>
                        <h2 style="font-size: 4em;">Fisioterapia El Vendrell</h2>
                        <p>Si buscas un centro de <strong>fisioterapia cerca</strong> de El Vendrell, nos encuentramos en Carrer Josep Irla Bosch, 22, 1-2, 43700 El Vendrell, un municipio de Tarragona, dispone de parking cerca, y servicios alrededor.</p>
                    </div>
                </div>
            </div>
            <div style="margin: 20px;">
                <div class="row">
                    ...
                    <div style="width: 100%"><iframe src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d3001.336096257541!2d1.5315174019276625!3d41.21444567485114!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e6!4m0!4m5!1s0x12a38b468e771aed%3A0x8296e1c9d2f9b028!2sFisioterapia%20El%20Vendrell%20-%20Sandra%20Tablado%2C%20Carrer%20Josep%20Irla%20Bosch%2C%2022%2C%201-2%2C%2043700%20El%20Vendrell%2C%20Tarragona!3m2!1d41.2141269!2d1.5313672!5e0!3m2!1ses!2ses!4v1605693050123!5m2!1ses!2ses"  width="100%" height="677" frameborder="0" style="border:0" allowfullscreen></iframe></div>
                    </div>
                </div>
            </div>
        </div>
